...
const Footer = () => {
  return (
    <footer className='top-[1080px] left-0 flex h-[317px] w-[1920px] items-center bg-[#252528]'>
      <div className='mx-auto flex h-[197px] w-[1200px] items-center justify-between'>
        <div className='flex h-[197px] w-[667px] flex-col justify-center'>
          ...
          <div className='mt-[19px] h-[32px] w-[596px]'>
            <p className='font-[Roboto] text-[12px] leading-[15.62px] text-[#bbbbbb] opacity-[0.62]'>
        ...
        <p className='font-Roboto self-end text-[12px] leading-[14.06px] text-[#bbbbbb] opacity-[0.62]'>
